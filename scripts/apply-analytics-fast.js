...
begin
  ...
  -- Totais gerais (usa índices de contagem/valor)
  select
    count(*)::integer,
  ...
  -- Mensal + MoM/YoY em uma passada no intervalo recente
  ...
  -- Rankings: top 10 por valor (somente ativas)
...
async function main() {
  ...
  console.log('analytics function updated');
  await client.end();
}
